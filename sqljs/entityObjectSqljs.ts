...
import { SqlJSDataContext } from "./dataContextSqljs";
...
export class EntityObjectSqlJS<T extends IEntityObject> extends EntityObject<T> {
    private interpreter: Interpreter;
    private ctx: SqlJSDataContext;
    private joinEntities = [];
    constructor(ctx?: SqlJSDataContext) {
        super();
